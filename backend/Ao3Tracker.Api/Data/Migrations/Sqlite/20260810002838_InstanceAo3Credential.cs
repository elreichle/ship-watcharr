...
namespace Ao3Tracker.Api.Data.Migrations.Sqlite
{
    ...
    public partial class InstanceAo3Credential : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ao3Username = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
        ...
        ///
        /// Byte-identical to the PostgreSQL migration's copy, and duplicated rather than shared on
        ...
        /// needs no <c>= TRUE</c>, which is what would otherwise have differed between this
        /// provider's integer boolean and PostgreSQL's real one.
        /// </summary>
