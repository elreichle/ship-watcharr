    ...
    private async Task<List<WatchedShipDto>> LoadWatchedShipsAsync(int? shipId, CancellationToken ct)
    {
        ...
        var rows = await _db.WatchedShips
            ...
            .Select(w => new
            {
                ...
                w.Ship.RecentSweepFrom,
                w.Ship.RecentSweepNextPage,
                w.Ship.LastRecentSweepStartedAt,
                w.Ship.LastRecentSweepCompletedAt,
        ...
        return [.. rows.Select(r => new WatchedShipDto(
            ...
            r.RecentSweepFrom,
            r.RecentSweepNextPage,
            r.LastRecentSweepStartedAt,
            r.LastRecentSweepCompletedAt))];
    }
